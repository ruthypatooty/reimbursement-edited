...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2021 at 08:41 PM
...
(2, 0, 'Admin', 'admin@admin.com', '$2y$10$MJBGS6I/VbN1iXna0RLTr.QZhaqpBq7cAdLoTvPqO8QaxBC3hqNOm');
...
--
ALTER TABLE `users`
  MODIFY `usersId` int(64) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
COMMIT;
